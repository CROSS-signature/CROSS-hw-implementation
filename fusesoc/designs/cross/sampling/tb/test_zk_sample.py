...
# Creating parameters
params = []
params.append({"DATA_WIDTH": str(64), "PAR_ELEMS": str(1)})
...
def test_zk_sample(parameters, env):
    tmp = env.copy()
    ...
    try:
        run(
            ...
            toplevel="tb_zk_sample",  # top level HDL
            module="tb_zk_sample",  # name of cocotb test module
