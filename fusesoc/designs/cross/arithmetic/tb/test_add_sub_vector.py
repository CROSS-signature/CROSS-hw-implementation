...
@pytest.mark.parametrize("DATA_WIDTH", DATA_WIDTH, ids=lambda x: pytest_id({"DATA_WIDTH": x}))
def test_add_sub_vector(VARIANT, CATEGORY, DATA_WIDTH):
    args = locals()
    ...
    try:
        run(
            ...
            toplevel="tb_add_sub_vector",  # top level HDL
            module="tb_add_sub_vector",  # name of cocotb test module
            defines=defines,
