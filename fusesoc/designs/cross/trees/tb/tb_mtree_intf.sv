...
(
    ...
    logic [W_FCNT-1:0]      ctrl_addr_frame_cnt;

    logic [ADDR_WIDTH-1:0]  sig_addr;
    logic                   sig_addr_we;
    logic                   sig_addr_valid;
    logic                   sig_addr_ready;
    logic [W_FCNT-1:0]      sig_addr_frame_cnt;

    logic sig_ctrl_proof_cnt_valid, ctrl_addr_is_proof;

    logic                               mtree_mem_en;
    logic [ADDR_WIDTH-1:0]              mtree_mem_addr;
    ...
    (
        .clk,
        .rst_n,
        .mtree_sign_done            ( sig_ctrl_proof_cnt_valid  ),
        .mtree_vrfy_addr_is_proof   ( ctrl_addr_is_proof        ),
        .mem_en                     ( mtree_mem_en              ),
    ...
    (
        ...
        .flag_last,
        .addr                       ( ctrl_addr             ),
        .addr_is_proof              ( ctrl_addr_is_proof    ),
