...
end entity mem_to_conv;


architecture structural of mem_to_conv is

    -- Signals from memory to width converter
    signal m_axis_mem_tdata_s   : std_logic_vector(CONVERTER_IN_WIDTH_G - 1 downto 0);
    signal m_axis_mem_tkeep_s   : std_logic_vector(CONVERTER_IN_WIDTH_G/8 - 1 downto 0);
    signal m_axis_mem_tvalid_s  : std_logic := '0';
    signal m_axis_mem_tready_s  : std_logic := '0';
    signal m_axis_mem_tlast_s   : std_logic;
...
begin
    ...
    port map(
        ...
        m_axis_tdata    => m_axis_mem_tdata_s,
        m_axis_tkeep    => m_axis_mem_tkeep_s,
        m_axis_tvalid   => m_axis_mem_tvalid_s,
        m_axis_tready   => m_axis_mem_tready_s,
        m_axis_tlast    => m_axis_mem_tlast_s
    );
    ...
    port map(
        axis_aclk       => axis_aclk,
        axis_rst        => axis_rst,
        s_axis_tdata    => m_axis_mem_tdata_s,
        s_axis_tkeep    => m_axis_mem_tkeep_s,
        s_axis_tvalid   => m_axis_mem_tvalid_s,
        s_axis_tready   => m_axis_mem_tready_s,
        s_axis_tlast    => m_axis_mem_tlast_s,
